...
try {
    ...
    $sql = "select cp.*, f.nome as nome_favorecido from conta_pagar cp inner join favorecido f on cp.favorecido = f.id where (cp.id like :palavra or cp.descricao like :palavra) and cp.usuario_id = :id order by cp.id asc ";
