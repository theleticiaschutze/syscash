...
require_once("conta_receber_crud.php");
...
class ContasReceberPDF extends FPDF
{
    // Page header
    function Header()
    {
        ...
        // Title
        $this->Cell(30, 10, 'Listagem de contas a receber', 0, 0, 'C');
...
$pdf = new ContasReceberPDF("L","mm","A4");
$pdf->AliasNbPages();
